...
pub const METHODS: &[Method] = &[
    ...
    Method::new_bool("setnetworkactive", "set_network_active"),
    ...
    Method::new_bool("abortrescan", "abort_rescan"),    Method::new_modelled("addmultisigaddress", "AddMultisigAddress", "add_multisig_address"),
    ...
    Method::new_string("encryptwallet", "encrypt_wallet"),
